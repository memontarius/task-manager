...
<template>
    <Head title="Главная"/>
    <Header/>
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4 pt-12">
        <main>
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                Тут пишут таски</h1>
            <p class="max-w-2xl mb-4 text-xl">Менеджер задач на Laravel</p>
            <div>
                <a href="#"
                   class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-700 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    Начать</a>
            </div>
        </main>
    </div>
